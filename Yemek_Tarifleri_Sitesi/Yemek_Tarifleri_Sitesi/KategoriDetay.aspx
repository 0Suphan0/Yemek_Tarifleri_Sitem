<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="Kullanici.Master" CodeBehind="KategoriDetay.aspx.cs" Inherits="Yemek_Tarifleri_Sitesi.KategoriDetay" %>
        ...
        <asp:DataList ID="DataList2" runat="server" Width="394px">
            <ItemTemplate>
                <table class="auto-style7">
                    <tr>
                        <td class="auto-style4"><a href="YemekDetay.aspx?yemekId=<%#Eval("yemek_id") %>">
                            <asp:Label ID="Label3" runat="server" Text='<%# Eval("yemek_ad") %>' Font-Size="18pt"></asp:Label>
                            </a></td>
                    </tr>
                    <tr>
                        <td class="auto-style11"><span class="auto-style8"><strong><span class="auto-style9">MALZEMELER</span></strong></span><br /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="auto-style11"><span class="auto-style9">Yemek Tarifi</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="auto-style5"><span class="auto-style9">Eklenme Tarihi:</span><asp:Label ID="Label6" runat="server" Text='<%# Eval("yemek_tarih") %>'></asp:Label>
